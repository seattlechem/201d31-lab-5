...
function multiply(a,b){ //eslint-disable-line
  var multiplyOfTwoNums = a * b;
  var message = 'The product of ' + a + ' and ' + b + ' is ' + multiplyOfTwoNums + '.';
  return [multiplyOfTwoNums, message];
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var productOfThreeNums = multiply(multiply(a, b)[0], c)[0];
...
function multiplyArray(testArray){ //eslint-disable-line
  var arrayprod = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  var message = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + arrayprod + '.';
  return [arrayprod, message];
